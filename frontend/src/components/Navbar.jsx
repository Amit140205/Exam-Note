            ...
            <div className='relative'>
                ...
                {showCredits && 
                    ...
                    className='absolute -right-12.5 mt-4 w-64 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white'>
                        ...
                        className='w-full py-2 rounded-lg bg-linear-to-br from-white to-gray-200 text-black font-semibold hover:opacity-90'>Buy More Credits</button>
                    </motion.div>
                    }
                    </AnimatePresence>  
            </div>
            ...
            <div className='relative'>
                ...
                {showProfile && 
                    ...
                    className='absolute right-0 mt-4 w-52 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white'>
                        ...
                        <MenuItem text="Sign Out" red onClick={()=>{
                            handleSignOut()
                            setShowProfile(false)
                        }}/>
