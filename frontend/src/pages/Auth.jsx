  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
      ...
      className='max-w-7xl mx-auto mt-8 rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 shadow-[0_20px_45px_rgba(0,0,0,0.6)]'>
       ...
       <h1 className='text-2xl font-bold bg-linear-to-r from-white via-gray-500 to-white bg-clip-text text-transparent'>ExamNotes AI</h1>
      ...
      <main className='max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
        ...
        >
          ...
          <p className='mt-8 max-w-xl text-lg bg-linear-to-br from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent'>
        ...
        <p className=' mt-4 bg-linear-to-br from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent'>Start with 50 free credits • Upgrade anytime for more credits • Instant access</p>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
          ...
          <Feature icon={"📘"} title={"Exam Notes"} des={"High-qield, revision-ready exam-oriented notes"}/>
...
function Feature({icon, title, des}){
  return (
    ...
    className='relative rounded-2xl p-5 bg-linear-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.7)] text-white'
