  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black'>
        ...
        <div>
          ...
          >
            ...
            className='mt-6 max-w-xl text-lg bg-linear-to-br from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent'>
              Generate exam-focused notes, projects documentation, flow diagrams and revision-ready content using AI - faster, cleaner and smarter
            </motion.p>
          ...
          <motion.button
              ...
              className='mt-10 px-10 py-3 rounded-xl flex items-center gap-3 bg-linear-to-br from-black/90 via-black/80 to-black/90 border border-white/10 text-white font-semibold text-lg shadow-[0_25px_60px_rgba(0,0,0,0.7)] cursor-pointer'
              >
      ...
      <section className='max-w-6xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-4 gap-10'>
        <Feature icon="📘" title="Exam Notes" des="High-yeild exam-oriented notes with revision points"/>
