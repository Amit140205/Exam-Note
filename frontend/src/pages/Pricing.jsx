...
function Pricing() {
  ...
  const handlePaying = async (amount) => {
    try {
      ...
      const response=await axios.post(serverUrl+"/api/credit/order", {amount}, {withCredentials:true})
  ...
  return (
    ...
    >
      ...
      <button
        ...
        ${isPayingThisCard ? "bg-gray-300 cursor-not-allowed" : isSelected ? "bg-black text-white" : "bg-indigo-600 text-white hover:bg-indigo-700 cursor-pointer"}  
        `}
      >
